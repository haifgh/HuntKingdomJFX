...
public class ProductInterfaceController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        try {
            ...
            Logger.getLogger(ProductInterfaceController.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    ...
    public void AddProduct(ActionEvent t) throws SQLException {
        ...
        try {
            ...
            FXMLLoader Loader = new FXMLLoader(getClass().getResource("/Views/ProductADDInterface.fxml")); //
  ...
  conn = Connexion.getInstance();
    ...
    private void refresh(ActionEvent event) throws IOException {
        ...
        Pane root = L.load(getClass().getResource("/Views/ProductInterface.fxml"));
